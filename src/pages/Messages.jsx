  ...
  return (
    <Layout>
      <div style={{
        ...
        {/* ── Inbox sidebar ── */}
        <div style={{ width: isMobile ? '100%' : 290, display: showList ? 'flex' : 'none', flexDirection:'column', overflowY:'auto', background: isMobile ? '#070710' : 'rgba(255,255,255,0.055)', backdropFilter: isMobile ? 'none' : 'blur(28px) saturate(150%)', WebkitBackdropFilter: isMobile ? 'none' : 'blur(28px) saturate(150%)', borderRight: isMobile ? 'none' : '1px solid rgba(255,255,255,0.10)', boxShadow:'inset 0 1px 0 rgba(255,255,255,0.07)' }}>
        ...
        {activeUser ? (
          <div style={{ flex:1, display: showChat ? 'flex' : 'none', flexDirection:'column', overflow:'hidden', width: isMobile ? '100%' : undefined }}>
            ...
            {/* Messages */}
            <div style={{ flex:1, overflowY:'auto', padding: isMobile ? '12px 14px' : '20px', display:'flex', flexDirection:'column', gap:4, background:'#070710' }}
